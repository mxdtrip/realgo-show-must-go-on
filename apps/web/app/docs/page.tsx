    ...
    <main className="landing-section legal-page">
      <article className="pattern-profile">
        ...
        <section className="pattern-profile__section" id="cards">
          ...
          <div className="pattern-profile__body">
            <p>
              Каждая решённая задача превращается в карточку: подход,
              механика решения, граничный случай. После честной оценки
              уверенности («сложно» / «нормально» / «уверенно») ReAlgo
              сдвигает следующий показ карточки — легко решённое всплывает
              реже, тяжёлое — чаще.
            </p>
            <p>
              Если ответ забылся совсем — ничего страшного, карточка просто
              вернётся раньше и чаще, пока не закрепится. Забытое становится
              не поводом для тревоги, а точным сигналом, что повторить в
              первую очередь.
            </p>
          </div>
        </section>
        ...
        <section className="pattern-profile__section" id="extension">
          ...
          <div className="pattern-profile__body">
            <p>
              Расширение фиксирует минимальный учебный контекст: платформу
              (LeetCode, NeetCode, HackerRank), задачу, статус решения,
              выбранную оценку уверенности и паттерн, если он известен.
              Закрытые материалы и содержимое premium-страниц ему не нужны.
            </p>
          </div>
        </section>
