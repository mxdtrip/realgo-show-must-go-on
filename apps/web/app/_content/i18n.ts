  ...
  cabinet: {
    ...
    pages: {
      ...
      roadmap: {
        ...
        statusTodo: "впереди",
        remainingTitle: "Закрыть до конца недели",
          ...
          items: [
            {
              ...
              confidence: 88,
              state: "почти закрыто",
              remaining: "1 карточка: частотный словарь и set lookup",
            },
            {
              name: "Two Pointers",
              code: "two_pointers",
              confidence: 92,
              state: "закрепить на medium",
              remaining: "2 повторения: 3Sum и Container With Most Water",
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              remaining: "3 hard review после week 01",
            },
            {
              name: "Stack",
              code: "stack",
              confidence: 84,
              state: "поддерживать",
              remaining: "1 edge-case карточка",
            },
            {
              name: "Binary Search",
              code: "binary_search",
              ...
              remaining: "2 карточки по left/right и пустому диапазону",
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              remaining: "2 задачи на обход и visited-state",
            },
            {
              name: "Intervals",
              code: "intervals",
              ...
              remaining: "2 карточки после Merge Intervals",
            },
            {
              name: "Dynamic Programming (1D)",
              code: "dynamic_programming_1d",
              confidence: 37,
              state: "переоткрыть",
              remaining: "3 карточки по состоянию и переходам",
            },
          ],
        },
      ],
