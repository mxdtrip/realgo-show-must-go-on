...
Браузерное расширение Engram на Plasmo и TypeScript с Manifest V3.
...
фиксирует факт submit, показывает короткий popup Engram с названием задачи и двумя
...
│   ├── popup.styles.ts     # стили-строка (дизайн-токены Engram), инжект через <style>
